<template lang="html">
  ...
  <svg id="svg" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 600 1200">
    ...
    <circle class="ball ball01" id="ball01" r="20" cx="50" cy="100" fill="orange"></circle>
    <circle class="ball ball02" r="20" cx="278" cy="201">2017</circle>
...
export default {
    ...
    //
    // const pulses = this.$gsap.timeline({
      // defaults: {
      //   scale: 2,
      //   autoAlpha:1,
    ...
    // });
    // this.$gsap.to(".ball02, .text01", {}, 0.84)
    // this.$gsap.to(".ball03, .text02", {}, 1.36)
    // this.$gsap.to(".ball04, .text03", {}, 1.92)
    //
    // const main = this.$gsap.timeline({
    //   scrollTrigger: {
    //     trigger: "#svg",
    //     scrub: true,
    //     start: "top center",
    ...
    //   }
    // })
    // this.$gsap.to(".ball01", {autoAlpha:1, duration:0.05})
    //// this.$gsap.from(".theLine", {drawSVG:0, duration:4}, 0)
